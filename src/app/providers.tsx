...
export const theme = extendTheme({
  ...
  colors: {
    gray: {
      ...
      900: "#18181b",
      925: "color-mix(in hsl, var(--chakra-colors-gray-900) 57%, var(--chakra-colors-gray-950))",
      950: "#09090b",
    },
  },
  components: {},
  semanticTokens: {
    ...
    borders: {
      ...
      normal: {
        ...
        _dark: "1px solid rgba(255, 255, 255, 0.12)",
      },
      strong: {
        default: "1px solid rgba(0, 0, 0, 0.16)",
        _dark: "1px solid rgba(255, 255, 255, 0.16)",
      },
      vivid: {
        default: "1px solid rgba(0, 0, 0, 0.2)",
        _dark: "1px solid rgba(255, 255, 255, 0.2)",
      },
    },
  },
});
